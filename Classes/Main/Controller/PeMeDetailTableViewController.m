//
//  PeMeDetailTableViewController.m
//  80 PeChat
//
...
#import "PeMeDetailTableViewController.h"
#import "PeXmppTool.h"
...
@interface PeMeDetailTableViewController ()<UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate,PeEditMeDelegate>
...
@implementation PeMeDetailTableViewController
...
-(void)loadVCard{
    ...
    self.weixinNumLabel.text = [PeUserInfo sharedPeUserInfo].user;
...
- (void)editProfileViewControllerDidSave
{
    ...
    [[PeXmppTool sharedPeXmppTool].vCard updateMyvCardTemp:myvCard];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([destVc isKindOfClass:[PeEditMeTableViewController class]]) {
        PeEditMeTableViewController *editVc = destVc;
        editVc.cell = sender;
