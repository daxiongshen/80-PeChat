 ...
 * the traditional PETERLog() function directs it's output to two places:
 * 
 * - Apple System Log (so it shows up in Console.app)
 * - StdErr (if stderr is a TTY, so log statements show up in Xcode console)
 * 
 * To duplicate PETERLog() functionality you can simply add this logger and an asl logger.
 ...
 * 
 * This would essentially give you a straight PETERLog replacement that prints in purple:
 * 
